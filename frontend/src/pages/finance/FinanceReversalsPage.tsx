    ...
    <div className="max-w-3xl mx-auto space-y-6 px-4 md:px-6 py-8">
      ...
      <Card className="border-slate-200">
        <CardHeader className="text-center pb-2">
          ...
          <CardTitle className="text-2xl">Payment Reversals</CardTitle>
        ...
        <CardContent className="text-center space-y-6">
          ...
          <div className="max-w-md mx-auto space-y-4 text-sm text-slate-600">
            <p>
              The Payment Reversals module will allow you to:
            </p>
            <ul className="text-left space-y-2 pl-4">
              <li className="flex items-start gap-2">
                <span className="text-emerald-500 mt-1">✓</span>
                Reverse incorrectly posted payments
              </li>
              <li className="flex items-start gap-2">
                <span className="text-emerald-500 mt-1">✓</span>
                Track all reversal requests and approvals
              </li>
              <li className="flex items-start gap-2">
                <span className="text-emerald-500 mt-1">✓</span>
                Maintain full audit trail of reversals
              </li>
              <li className="flex items-start gap-2">
                <span className="text-emerald-500 mt-1">✓</span>
                Multi-level approval workflow for reversals
              </li>
            </ul>
          </div>

          <div className="pt-4">
            <Button onClick={() => navigate('/finance/postings')} className="bg-emerald-600 hover:bg-emerald-700">
              View Today's Postings
            </Button>
          </div>
        </CardContent>
      </Card>
