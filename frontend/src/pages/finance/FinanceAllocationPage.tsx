...
import { PieChart, ArrowLeft, Clock } from 'lucide-react';
import { useNavigate } from 'react-router-dom';

export default function FinanceAllocationPage() {
    ...
    <div className="max-w-3xl mx-auto space-y-6 px-4 md:px-6 py-8">
      ...
      <Card className="border-slate-200">
        <CardHeader className="text-center pb-2">
          ...
          <CardTitle className="text-2xl">Allocation Breakdown</CardTitle>
        ...
        <CardContent className="text-center space-y-6">
          ...
          <div className="max-w-md mx-auto space-y-4 text-sm text-slate-600">
            <p>
              The Allocation Breakdown module will allow you to:
            </p>
            <ul className="text-left space-y-2 pl-4">
              <li className="flex items-start gap-2">
                <span className="text-emerald-500 mt-1">✓</span>
                See how payments are allocated (principal, interest, fees)
              </li>
              <li className="flex items-start gap-2">
                <span className="text-emerald-500 mt-1">✓</span>
                View allocation by loan product type
              </li>
              <li className="flex items-start gap-2">
                <span className="text-emerald-500 mt-1">✓</span>
                Analyze revenue breakdown over time
              </li>
              <li className="flex items-start gap-2">
                <span className="text-emerald-500 mt-1">✓</span>
                Export detailed allocation reports
              </li>
            </ul>
          </div>
