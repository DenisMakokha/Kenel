...
const SCAN_STATUS_CONFIG: Record<string, { label: string; color: string; bg: string; border: string; icon: any }> = {
  ...
  clean: { label: 'Clean', color: 'text-emerald-700', bg: 'bg-emerald-100', border: 'border-emerald-300', icon: CheckCircle },
  infected: { label: 'Threat Found', color: 'text-red-700', bg: 'bg-red-100', border: 'border-red-300', icon: AlertTriangle },
};
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl p-5 border border-amber-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-amber-600 font-medium">Scanning</p>
